...
interface TaskInterface
{
    ...
    public function registerTaskManager(string $taskUrl, TaskManagerInterface $taskManager): TaskInterface;

    public function registerResult(TaskManagerInterface $taskManager): TaskInterface;
}